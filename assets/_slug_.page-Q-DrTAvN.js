import{ɵ as q,C as V,N as Lt,R as _t,g as h,l as f,a as l,b as d,c,h as Y,n as g,k as s,m as F,o as Pt,p as T,q as b,L as jt,w as G,z as w,B as y,v as et,t as C,e as v,E as W,M as zt,O as vt,F as U,P as At,Q as Nt,S as Dt,T as Et,U as $t,V as it,W as Ht,s as wt,X as Bt,Y as Rt,Z as Gt,_ as yt,$ as It,a0 as ht,G as R,H as S,K as ut,J as Zt,D as Q,a1 as Ut,i as qt,f as J,a2 as Vt,a3 as Yt,a4 as Ft,a5 as Wt,x as I,y as O,a6 as Qt,a7 as ft,a8 as bt,j as Jt,d as Xt,a9 as Kt}from"./index-BXLWmGkl.js";import{p as tn}from"./pagination-config-BIRU8DJ8.js";import{F as nn}from"./format-date.pipe--ARP_MZT.js";function en(o){const n=[],t=/<h([1-4])[^>]*?(?:id=\"([^\"]*)\")?[^>]*>([\s\S]*?)<\/h\1>/gi;let e;for(;(e=t.exec(o))!==null;){const i=parseInt(e[1],10),r=e[2]||on(Mt(e[3])),a=an(Mt(e[3]).trim());n.push({level:i,text:a,id:r})}return n}function Mt(o){return o.replace(/<[^>]*>/g,"")}function on(o){return o.toLowerCase().replace(/[^a-z0-9\s-]/g,"").trim().replace(/\s+/g,"-").replace(/-+/g,"-")}function an(o){return o.replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"').replace(/&#39;/g,"'")}const rn=()=>[],sn=(o,n)=>n.id;function cn(o,n){if(o&1){const t=Pt();l(0,"li",4)(1,"a",5),T("click",function(){const i=w(t).$implicit,r=g(2);return y(r.scrollToElement(i.id))}),d(2),c()()}if(o&2){const t=n.$implicit;b("ngClass","toc__item--level-"+t.level),s(),b("routerLink",jt(4,rn))("fragment",t.id),s(),G(" ",t.text," ")}}function ln(o,n){if(o&1&&(l(0,"aside",0)(1,"nav",1)(2,"h3",2),d(3,"Table of Contents"),c(),l(4,"ul",3),Y(5,cn,3,5,"li",4,sn),c()()()),o&2){const t=g();s(5),F(t.headings)}}const L=class L{constructor(){this.headings=[]}scrollToElement(n){setTimeout(()=>{const t=document.getElementById(n);t&&t.scrollIntoView({behavior:"smooth",block:"start"})},0)}};L.ɵfac=function(t){return new(t||L)},L.ɵcmp=q({type:L,selectors:[["app-table-of-contents"]],inputs:{headings:"headings"},decls:1,vars:1,consts:[[1,"toc"],[1,"toc__nav"],[1,"toc__title"],[1,"toc__list"],[1,"toc__item",3,"ngClass"],[1,"toc__link",3,"click","routerLink","fragment"]],template:function(t,e){t&1&&h(0,ln,7,0,"aside",0),t&2&&f(e.headings.length>0?0:-1)},dependencies:[V,Lt,_t],styles:[`.toc[_ngcontent-%COMP%] {
      position: sticky;
      top: 100px;
    ...
    }`]});let at=L;const Ot=o=>["/blog",o];function dn(o,n){if(o&1&&(l(0,"a",1)(1,"span",4),d(2,"← Previous"),c(),l(3,"span",5),d(4),c()()),o&2){const t=g();b("routerLink",et(2,Ot,t.previousPost.attributes.slug)),s(4),C(t.previousPost.attributes.title)}}function pn(o,n){o&1&&v(0,"div",2)}function gn(o,n){if(o&1&&(l(0,"a",3)(1,"span",4),d(2,"Next →"),c(),l(3,"span",5),d(4),c()()),o&2){const t=g();b("routerLink",et(2,Ot,t.nextPost.attributes.slug)),s(4),C(t.nextPost.attributes.title)}}function _n(o,n){o&1&&v(0,"div",2)}const j=class j{constructor(){this.previousPost=null,this.nextPost=null}};j.ɵfac=function(t){return new(t||j)},j.ɵcmp=q({type:j,selectors:[["app-post-navigation"]],inputs:{previousPost:"previousPost",nextPost:"nextPost"},decls:5,vars:2,consts:[[1,"post-nav"],[1,"post-nav__link","post-nav__link--prev",3,"routerLink"],[1,"post-nav__placeholder"],[1,"post-nav__link","post-nav__link--next",3,"routerLink"],[1,"post-nav__label"],[1,"post-nav__title"]],template:function(t,e){t&1&&(l(0,"nav",0),h(1,dn,5,4,"a",1)(2,pn,1,0,"div",2),h(3,gn,5,4,"a",3)(4,_n,1,0,"div",2),c()),t&2&&(s(),f(e.previousPost?1:2),s(2),f(e.nextPost?3:4))},dependencies:[_t,V],styles:[`.post-nav[_ngcontent-%COMP%] {
      display: grid;
...
</div>`})}const z=class z{transform(n){return n&&typeof n=="string"?mn(n):""}};z.ɵfac=function(t){return new(t||z)},z.ɵpipe=W({name:"admonitionTransform",type:z,pure:!0});let st=z;const A=class A{transform(n){if(!n)return"";const t=new Map;let e=n;const i=/:::footnotes\s*\n([\s\S]*?)\n:::/g,r=i.exec(n);if(r){const u=r[1],m=/^\[\^([^\]]+)\]:\s*(.+)$/gm;let x;for(;(x=m.exec(u))!==null;){const P=x[1].trim(),Z=x[2].trim();P&&t.set(P,Z)}e=n.replace(i,"").trim()}else{const m=/\n\n(\[\^[^\]]+\]:.+\n?)+$/.exec(n);if(m){const x=m[0],P=/^\[\^([^\]]+)\]:\s*(.+)$/gm;let Z;for(;(Z=P.exec(x))!==null;){const mt=Z[1].trim(),St=Z[2].trim();mt&&t.set(mt,St)}e=n.substring(0,n.length-x.length).trim()}}const a=new Map,_=new Map;let p=0;const M=/\[\^([^\]]+)\]/g;if(e.replace(M,(u,m)=>{const x=String(m).trim();return a.has(x)||(p+=1,a.set(x,p),_.set(p,x)),""}),e=e.replace(M,(u,m)=>{const x=String(m).trim(),P=a.get(x);return P?`<sup><a data-fn="fn-${P}" id="fnref-${P}" class="footnote-ref" role="button" tabindex="0">[${P}]</a></sup>`:u}),a.size>0){let u=`
...
`,e+=u}return e}parseMarkdownLinks(n){return n.replace(/\[([^\]]+)\]\(([^)]+)\)/g,(t,e,i)=>{let r=i;return!i.startsWith("http://")&&!i.startsWith("https://")&&!i.startsWith("/")&&(r=`https://${i}`),`<a href="${r}" target="_blank" rel="noopener noreferrer">${e}</a>`})}};A.ɵfac=function(t){return new(t||A)},A.ɵpipe=W({name:"processFootnotes",type:A,pure:!0});let ct=A;const N=class N{transform(n){if(!n)return"";let t=n;return t=this.processComboFormat(t),t=this.processBackgroundColor(t),t=this.processTextColor(t),t=this.processFontWeight(t),t=this.processAlignment(t),t=this.processBold(t),t=this.processItalic(t),t=this.processStrikethrough(t),t}processComboFormat(n){const t=/::combo\[([^\]]+)\]\{([^}]+)\}/g;return n.replace(t,(e,i,r)=>{const a=this.parseComboAttributes(i),_=[],p=[];a.bg&&p.push(`background-color: ${this.sanitizeColor(a.bg)}`),a.color&&p.push(`color: ${this.sanitizeColor(a.color)}`),a.weight&&p.push(`font-weight: ${this.sanitizeWeight(a.weight)}`),a.align&&_.push(`text-align-${this.sanitizeAlign(a.align)}`),a.bold==="true"&&p.push("font-weight: bold"),a.italic==="true"&&p.push("font-style: italic"),a.strike==="true"&&p.push("text-decoration: line-through");const M=_.length>0?` class="${_.join(" ")}"`:"",u=p.length>0?` style="${p.join("; ")}"`:"";return`<span${M}${u}>${r}</span>`})}parseComboAttributes(n){const t={},e=n.split(";");for(const i of e){const[r,a]=i.split(":").map(_=>_.trim());r&&a&&(t[r]=a)}return t}processBackgroundColor(n){const t=/::bg\[([^\]]+)\]\{([^}]+)\}/g;return n.replace(t,(e,i,r)=>`<span style="background-color: ${this.sanitizeColor(i)}">${r}</span>`)}processTextColor(n){const t=/::color\[([^\]]+)\]\{([^}]+)\}/g;return n.replace(t,(e,i,r)=>`<span style="color: ${this.sanitizeColor(i)}">${r}</span>`)}processFontWeight(n){const t=/::weight\[([^\]]+)\]\{([^}]+)\}/g;return n.replace(t,(e,i,r)=>`<span style="font-weight: ${this.sanitizeWeight(i)}">${r}</span>`)}processAlignment(n){const t=/::align\[([^\]]+)\]\{([^}]+)\}/g;return n.replace(t,(e,i,r)=>`<span class="text-align-${this.sanitizeAlign(i)}">${r}</span>`)}processBold(n){const t=/::bold\{([^}]+)\}/g;return n.replace(t,'<span style="font-weight: bold">$1</span>')}processItalic(n){const t=/::italic\{([^}]+)\}/g;return n.replace(t,'<span style="font-style: italic">$1</span>')}processStrikethrough(n){const t=/::strike\{([^}]+)\}/g;return n.replace(t,'<span style="text-decoration: line-through">$1</span>')}sanitizeColor(n){const t=n.trim().toLowerCase();return["black","white","red","green","blue","yellow","orange","purple","pink","brown","gray","grey","cyan","magenta","lime","navy","teal","olive","maroon","aqua","fuchsia","silver","darkred","darkgreen","darkblue","lightgray","lightblue","lightgreen","lightyellow","transparent"].includes(t)||/^#([0-9a-f]{3}|[0-9a-f]{6})$/i.test(t)||/^rgba?\([^)]+\)$/i.test(t)?t:"inherit"}sanitizeWeight(n){const t=n.trim().toLowerCase();if(["normal","bold","bolder","lighter"].includes(t))return t;const e=parseInt(t,10);return!isNaN(e)&&e>=100&&e<=900&&e%100===0?e.toString():"normal"}sanitizeAlign(n){const t=n.trim().toLowerCase();return["left","center","right","justify"].includes(t)?t:"left"}};N.ɵfac=function(t){return new(t||N)},N.ɵpipe=W({name:"textFormat",type:N,pure:!0});let lt=N;const D=class D{transform(n){if(!n)return"";let t=n;return t=this.processQuoteCards(t),t=this.processVerseCards(t),t=this.processEpicCards(t),t=this.processHighlightCards(t),t=this.processGenericCards(t),t=this.processOlaiCards(t),t=this.processNewspaperCards(t),t}processQuoteCards(n){const t=/::quote\[([^\]]+)\]\{([^}]+)\}/g;let e=n.replace(t,(r,a,_)=>{const p=a.trim();return`<div class="card card--quote">
  ...
  <div class="card__newspaper-content">
    ...
    </div>`}escapeHtml(n){const t={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};return n.replace(/[&<>"']/g,e=>t[e]||e)}};E.ɵfac=function(t){return new(t||E)},E.ɵpipe=W({name:"tabs",type:E,pure:!0});let pt=E;const hn={passwordHash:"ace3ec3d2bca9a0c0e280b3f654b9254965d7696",expiryTime:1440*60*1e3},X={},ot=hn,k=class k{constructor(){this.STORAGE_KEY="blog_auth_cache",this.EXPIRY_TIME=ot.expiryTime}async sha1(n){const t=new TextEncoder().encode(n),e=await crypto.subtle.digest("SHA-1",t);return Array.from(new Uint8Array(e)).map(a=>a.toString(16).padStart(2,"0")).join("")}async validatePassword(n){const t=await this.sha1(n),e=globalThis.__PASSWORD_HASH__,i=X.VITE_PASSWORD_HASH,r=X.VITE_USER_PASS_HASH,a=ot.passwordHash;return t===e&&e?e:t===i&&i?i:t===r&&r?r:t===a&&a&&a!=="PASSWORD_HASH_PLACEHOLDER"?a:null}isAuthenticated(){const n=this.getCachedAuth();if(!n)return!1;if(Date.now()-n.timestamp>this.EXPIRY_TIME)return this.clearCache(),!1;const e=globalThis.__PASSWORD_HASH__,i=X.VITE_PASSWORD_HASH,r=X.VITE_USER_PASS_HASH,a=ot.passwordHash,_=n.hash===a;return n.hash===e||n.hash===i||n.hash===r||_}saveAuth(n){const t={hash:n,timestamp:Date.now()};localStorage.setItem(this.STORAGE_KEY,JSON.stringify(t))}getCachedAuth(){try{const n=localStorage.getItem(this.STORAGE_KEY);return n?JSON.parse(n):null}catch{return null}}clearCache(){localStorage.removeItem(this.STORAGE_KEY)}getRemainingTime(){const n=this.getCachedAuth();if(!n)return 0;const t=Date.now()-n.timestamp;return Math.max(0,this.EXPIRY_TIME-t)}};k.ɵfac=function(t){return new(t||k)},k.ɵprov=zt({token:k,factory:k.ɵfac,providedIn:"root"});let tt=k;function fn(o,n){o&1&&(l(0,"span"),d(1,"👁️"),c())}function bn(o,n){o&1&&(l(0,"span"),d(1,"🙈"),c())}function Mn(o,n){if(o&1&&(l(0,"p",16),d(1),c()),o&2){const t=g(2);s(),C(t.errorMessage())}}function Cn(o,n){if(o&1){const t=Pt();l(0,"div",2),T("click",function(i){w(t);const r=g();return y(r.onOverlayClick(i))}),l(1,"div",3),T("click",function(i){return w(t),y(i.stopPropagation())}),l(2,"div",4)(3,"h2"),d(4,"🔒 Protected Content"),c(),l(5,"button",5),T("click",function(){w(t);const i=g();return y(i.cancel())}),d(6,"×"),c()(),l(7,"div",6)(8,"p",7),d(9,"This article is password protected. Please enter the password to continue."),c(),l(10,"div",8)(11,"input",9,0),Ht("ngModelChange",function(i){w(t);const r=g();return Gt(r.password,i)||(r.password=i),y(i)}),T("keyup.enter",function(){w(t);const i=g();return y(i.submit())}),c(),l(13,"button",10),T("click",function(){w(t);const i=g();return y(i.togglePasswordVisibility())}),it(14,fn,2,0,"span",11)(15,bn,2,0,"span",11),c()(),it(16,Mn,2,1,"p",12),c(),l(17,"div",13)(18,"button",14),T("click",function(){w(t);const i=g();return y(i.cancel())}),d(19,"Cancel"),c(),l(20,"button",15),T("click",function(){w(t);const i=g();return y(i.submit())}),d(21),c()()()()}if(o&2){const t=g();s(11),wt("error",t.errorMessage()),b("type",t.showPassword()?"text":"password"),Bt("ngModel",t.password),s(2),Rt("aria-label",t.showPassword()?"Hide password":"Show password"),s(),b("ngIf",!t.showPassword()),s(),b("ngIf",t.showPassword()),s(),b("ngIf",t.errorMessage()),s(4),b("disabled",t.isValidating()),s(),G(" ",t.isValidating()?"Validating...":"Unlock"," ")}}const $=class ${constructor(){this.authService=vt(tt),this.isVisible=U(!1),this.password="",this.showPassword=U(!1),this.errorMessage=U(""),this.isValidating=U(!1)}show(){return this.isVisible.set(!0),this.password="",this.showPassword.set(!1),this.errorMessage.set(""),this.isValidating.set(!1),new Promise(n=>{this.resolvePromise=n})}hide(){this.isVisible.set(!1),this.password="",this.errorMessage.set("")}togglePasswordVisibility(){this.showPassword.set(!this.showPassword())}onOverlayClick(n){this.cancel()}async submit(){if(!this.password.trim()){this.errorMessage.set("Please enter a password");return}this.isValidating.set(!0),this.errorMessage.set("");try{const n=await this.authService.validatePassword(this.password);n?(this.authService.saveAuth(n),this.hide(),this.resolvePromise?.(!0)):(this.errorMessage.set("Incorrect password. Please try again."),this.password="")}catch(n){this.errorMessage.set("An error occurred. Please try again."),console.error("Password validation error:",n)}finally{this.isValidating.set(!1)}}cancel(){this.hide(),this.resolvePromise?.(!1)}};$.ɵfac=function(t){return new(t||$)},$.ɵcmp=q({type:$,selectors:[["app-password-modal"]],decls:1,vars:1,consts:[["passwordInput",""],["class","modal-overlay",3,"click",4,"ngIf"],[1,"modal-overlay",3,"click"],[1,"modal-content",3,"click"],[1,"modal-header"],["aria-label","Close",1,"close-btn",3,"click"],[1,"modal-body"],[1,"modal-message"],[1,"password-input-group"],["placeholder","Enter password","autofocus","",1,"password-input",3,"ngModelChange","keyup.enter","type","ngModel"],["type","button",1,"toggle-password-btn",3,"click"],[4,"ngIf"],["class","error-message",4,"ngIf"],[1,"modal-footer"],[1,"btn","btn-cancel",3,"click"],[1,"btn","btn-submit",3,"click","disabled"],[1,"error-message"]],template:function(t,e){t&1&&it(0,Cn,22,10,"div",1),t&2&&b("ngIf",e.isVisible())},dependencies:[V,At,Nt,Dt,Et,$t],styles:[`.modal-overlay[_ngcontent-%COMP%] {
      position: fixed;
      top: 0;
      left: 0;
      right: 0;
    ...
    }`]});let nt=$;const K={enabled:!0,showOnAllPosts:!0,sectionTitle:"Support This Content",message:"If you found this content helpful, consider supporting the author.",showAfterDisclaimer:!0},Ct=[{name:"GPay",url:"",icon:"gpay",enabled:!0,type:"qr",upiId:"anand@oksbi",qrImage:"gpay-anand.png",description:"Pay via UPI using Google Pay or any UPI app"},{name:"PayPal",url:"https://paypal.me/actionanand",icon:"paypal",enabled:!0,type:"redirect",description:"Support via PayPal"},{name:"Buy Me A Coffee",url:"https://buymeacoffee.com/actionanand",icon:"buymeacoffee",enabled:!0,type:"redirect",description:"Buy me a coffee to support my work"},{name:"GitHub Sponsors",url:"https://github.com/sponsors/actionanand",icon:"github-sponsors",enabled:!0,type:"redirect",description:"Become a GitHub sponsor"},{name:"Patreon",url:"https://patreon.com/yourusername",icon:"patreon",enabled:!1,type:"redirect",description:"Support via Patreon"},{name:"Ko-fi",url:"https://ko-fi.com/actionanand",icon:"kofi",enabled:!0,type:"redirect",description:"Support via Ko-fi"}],xn=(o,n)=>n.name;function Pn(o,n){if(o&1&&(R(0,"p",4),d(1),S()),o&2){const t=g(2);s(),C(t.getDonationMessage())}}function vn(o,n){if(o&1&&(R(0,"a",7)(1,"span",9),d(2),S()()),o&2){const t=n.$implicit;ut("href",t.url,Q)("title",t.description),s(2),C(t.name)}}function wn(o,n){if(o&1&&Zt(0,"img",11),o&2){let t;const e=g(3);ut("src",e.getAssetPath((t=e.gpay())==null?null:t.qrImage),Q)("alt","GPay QR for UPI "+(e.getUpiId(e.gpay())||""))}}function yn(o,n){if(o&1&&(R(0,"div",8)(1,"div",10),h(2,wn,1,2,"img",11),R(3,"div",12)(4,"p",13),d(5),S()()()()),o&2){let t,e;const i=g(2);s(),ut("title",((t=i.gpay())==null?null:t.description)??"UPI via GPay"),s(),f((e=i.gpay())!=null&&e.qrImage?2:-1),s(3),C(i.getUpiId(i.gpay()))}}function In(o,n){if(o&1&&(R(0,"div",0)(1,"div",1)(2,"div",2)(3,"h3",3),d(4),S(),h(5,Pn,2,1,"p",4),S(),R(6,"div",5)(7,"div",6),Y(8,vn,3,3,"a",7,xn),S(),h(10,yn,6,3,"div",8),S()()()),o&2){const t=g();s(4),C(t.donationConfig.sectionTitle),s(),f(t.getDonationMessage()?5:-1),s(3),F(t.redirectPlatforms()),s(2),f(t.gpay()?10:-1)}}const H=class H{constructor(){this.platformId=vt(yt),this.isBrowser=It(this.platformId),this.donationConfig=K,this.redirectPlatforms=ht(()=>Ct.filter(n=>n.enabled&&n.type==="redirect")),this.gpay=ht(()=>Ct.find(n=>n.enabled&&n.name==="GPay")??null)}shouldShowDonation(){return K.enabled?this.getPostAttribute("enableDonation")===!1?!1:K.showOnAllPosts?!0:this.getPostAttribute("enableDonation")===!0:this.getPostAttribute("enableDonation")===!0}getPostAttribute(n){if(!(!this.postAttributes||Object.keys(this.postAttributes).length===0))return this.postAttributes[n]}getDonationMessage(){return this.getPostAttribute("donationMessage")||K.message||""}getUpiId(n){return n?n.upiId??"":""}getAssetPath(n){if(!n)return"";if(!this.isBrowser)return`/${n}`;const t=document.querySelector("base")?.getAttribute("href")||"/";return`${t.endsWith("/")?t:`${t}/`}${n}`}};H.ɵfac=function(t){return new(t||H)},H.ɵcmp=q({type:H,selectors:[["app-donation"]],inputs:{postAttributes:"postAttributes"},decls:1,vars:1,consts:[[1,"donation-section"],[1,"donation-container"],[1,"donation-header"],[1,"donation-title"],[1,"donation-message"],[1,"donation-platforms"],[1,"donation-row","donation-row-links"],["target","_blank","rel","noopener noreferrer",1,"donation-platform","redirect-platform",3,"href","title"],[1,"donation-row","donation-row-gpay"],[1,"platform-name"],[1,"gpay-card",3,"title"],[1,"gpay-qr",3,"src","alt"],[1,"gpay-upi"],[1,"gpay-upi-id"]],template:function(t,e){t&1&&h(0,In,11,3,"div",0),t&2&&f(e.shouldShowDonation()?0:-1)},dependencies:[V],styles:[`
