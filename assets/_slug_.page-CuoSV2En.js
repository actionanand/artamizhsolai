import{ɵ as q,C as Y,N as Lt,R as gt,g as h,l as f,a as l,b as d,c,h as F,n as g,k as s,m as V,o as xt,p as T,t as b,F as jt,v as G,y as w,z as y,u as et,r as C,e as P,E as W,G as St,H as vt,I as U,J as zt,K as Nt,L as Dt,M as At,O as Et,P as ot,Q as $t,q as Pt,S as Bt,T as Rt,U as Ht,V as wt,W as yt,X as mt,Y as H,Z as L,_ as _t,$ as Gt,D as Q,a0 as Zt,i as Ut,f as J,a1 as qt,a2 as Yt,a3 as Ft,a4 as Vt,w as I,x as O,a5 as Wt,a6 as ht,a7 as ft,j as Qt,d as Jt,a8 as Xt}from"./index-wW7bf8fX.js";import{p as Kt}from"./pagination-config-BIRU8DJ8.js";import{F as tn}from"./format-date.pipe-0GneOGBG.js";function nn(o){const n=[],t=/<h([1-4])[^>]*?(?:id=\"([^\"]*)\")?[^>]*>([\s\S]*?)<\/h\1>/gi;let e;for(;(e=t.exec(o))!==null;){const i=parseInt(e[1],10),r=e[2]||en(bt(e[3])),a=on(bt(e[3]).trim());n.push({level:i,text:a,id:r})}return n}function bt(o){return o.replace(/<[^>]*>/g,"")}function en(o){return o.toLowerCase().replace(/[^a-z0-9\s-]/g,"").trim().replace(/\s+/g,"-").replace(/-+/g,"-")}function on(o){return o.replace(/&amp;/g,"&").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"').replace(/&#39;/g,"'")}const an=()=>[],rn=(o,n)=>n.id;function sn(o,n){if(o&1){const t=xt();l(0,"li",4)(1,"a",5),T("click",function(){const i=w(t).$implicit,r=g(2);return y(r.scrollToElement(i.id))}),d(2),c()()}if(o&2){const t=n.$implicit;b("ngClass","toc__item--level-"+t.level),s(),b("routerLink",jt(4,an))("fragment",t.id),s(),G(" ",t.text," ")}}function cn(o,n){if(o&1&&(l(0,"aside",0)(1,"nav",1)(2,"h3",2),d(3,"Table of Contents"),c(),l(4,"ul",3),F(5,sn,3,5,"li",4,rn),c()()()),o&2){const t=g();s(5),V(t.headings)}}const j=class j{constructor(){this.headings=[]}scrollToElement(n){setTimeout(()=>{const t=document.getElementById(n);t&&t.scrollIntoView({behavior:"smooth",block:"start"})},0)}};j.ɵfac=function(t){return new(t||j)},j.ɵcmp=q({type:j,selectors:[["app-table-of-contents"]],inputs:{headings:"headings"},decls:1,vars:1,consts:[[1,"toc"],[1,"toc__nav"],[1,"toc__title"],[1,"toc__list"],[1,"toc__item",3,"ngClass"],[1,"toc__link",3,"click","routerLink","fragment"]],template:function(t,e){t&1&&h(0,cn,7,0,"aside",0),t&2&&f(e.headings.length>0?0:-1)},dependencies:[Y,Lt,gt],styles:[`.toc[_ngcontent-%COMP%] {
      position: sticky;
      top: 100px;
    ...
    }`]});let it=j;const It=o=>["/blog",o];function ln(o,n){if(o&1&&(l(0,"a",1)(1,"span",4),d(2,"← Previous"),c(),l(3,"span",5),d(4),c()()),o&2){const t=g();b("routerLink",et(2,It,t.previousPost.attributes.slug)),s(4),C(t.previousPost.attributes.title)}}function dn(o,n){o&1&&P(0,"div",2)}function pn(o,n){if(o&1&&(l(0,"a",3)(1,"span",4),d(2,"Next →"),c(),l(3,"span",5),d(4),c()()),o&2){const t=g();b("routerLink",et(2,It,t.nextPost.attributes.slug)),s(4),C(t.nextPost.attributes.title)}}function gn(o,n){o&1&&P(0,"div",2)}const S=class S{constructor(){this.previousPost=null,this.nextPost=null}};S.ɵfac=function(t){return new(t||S)},S.ɵcmp=q({type:S,selectors:[["app-post-navigation"]],inputs:{previousPost:"previousPost",nextPost:"nextPost"},decls:5,vars:2,consts:[[1,"post-nav"],[1,"post-nav__link","post-nav__link--prev",3,"routerLink"],[1,"post-nav__placeholder"],[1,"post-nav__link","post-nav__link--next",3,"routerLink"],[1,"post-nav__label"],[1,"post-nav__title"]],template:function(t,e){t&1&&(l(0,"nav",0),h(1,ln,5,4,"a",1)(2,dn,1,0,"div",2),h(3,pn,5,4,"a",3)(4,gn,1,0,"div",2),c()),t&2&&(s(),f(e.previousPost?1:2),s(2),f(e.nextPost?3:4))},dependencies:[gt,Y],styles:[`.post-nav[_ngcontent-%COMP%] {
      display: grid;
...
</div>`})}const z=class z{transform(n){return n&&typeof n=="string"?un(n):""}};z.ɵfac=function(t){return new(t||z)},z.ɵpipe=W({name:"admonitionTransform",type:z,pure:!0});let rt=z;const N=class N{transform(n){if(!n)return"";const t=new Map;let e=n;const i=/:::footnotes\s*\n([\s\S]*?)\n:::/g,r=i.exec(n);if(r){const u=r[1],m=/^\[\^([^\]]+)\]:\s*(.+)$/gm;let x;for(;(x=m.exec(u))!==null;){const v=x[1].trim(),Z=x[2].trim();v&&t.set(v,Z)}e=n.replace(i,"").trim()}else{const m=/\n\n(\[\^[^\]]+\]:.+\n?)+$/.exec(n);if(m){const x=m[0],v=/^\[\^([^\]]+)\]:\s*(.+)$/gm;let Z;for(;(Z=v.exec(x))!==null;){const ut=Z[1].trim(),kt=Z[2].trim();ut&&t.set(ut,kt)}e=n.substring(0,n.length-x.length).trim()}}const a=new Map,_=new Map;let p=0;const M=/\[\^([^\]]+)\]/g;if(e.replace(M,(u,m)=>{const x=String(m).trim();return a.has(x)||(p+=1,a.set(x,p),_.set(p,x)),""}),e=e.replace(M,(u,m)=>{const x=String(m).trim(),v=a.get(x);return v?`<sup><a data-fn="fn-${v}" id="fnref-${v}" class="footnote-ref" role="button" tabindex="0">[${v}]</a></sup>`:u}),a.size>0){let u=`
...
`,e+=u}return e}parseMarkdownLinks(n){return n.replace(/\[([^\]]+)\]\(([^)]+)\)/g,(t,e,i)=>{let r=i;return!i.startsWith("http://")&&!i.startsWith("https://")&&!i.startsWith("/")&&(r=`https://${i}`),`<a href="${r}" target="_blank" rel="noopener noreferrer">${e}</a>`})}};N.ɵfac=function(t){return new(t||N)},N.ɵpipe=W({name:"processFootnotes",type:N,pure:!0});let st=N;const D=class D{transform(n){if(!n)return"";let t=n;return t=this.processComboFormat(t),t=this.processBackgroundColor(t),t=this.processTextColor(t),t=this.processFontWeight(t),t=this.processAlignment(t),t=this.processBold(t),t=this.processItalic(t),t=this.processStrikethrough(t),t}processComboFormat(n){const t=/::combo\[([^\]]+)\]\{([^}]+)\}/g;return n.replace(t,(e,i,r)=>{const a=this.parseComboAttributes(i),_=[],p=[];a.bg&&p.push(`background-color: ${this.sanitizeColor(a.bg)}`),a.color&&p.push(`color: ${this.sanitizeColor(a.color)}`),a.weight&&p.push(`font-weight: ${this.sanitizeWeight(a.weight)}`),a.align&&_.push(`text-align-${this.sanitizeAlign(a.align)}`),a.bold==="true"&&p.push("font-weight: bold"),a.italic==="true"&&p.push("font-style: italic"),a.strike==="true"&&p.push("text-decoration: line-through");const M=_.length>0?` class="${_.join(" ")}"`:"",u=p.length>0?` style="${p.join("; ")}"`:"";return`<span${M}${u}>${r}</span>`})}parseComboAttributes(n){const t={},e=n.split(";");for(const i of e){const[r,a]=i.split(":").map(_=>_.trim());r&&a&&(t[r]=a)}return t}processBackgroundColor(n){const t=/::bg\[([^\]]+)\]\{([^}]+)\}/g;return n.replace(t,(e,i,r)=>`<span style="background-color: ${this.sanitizeColor(i)}">${r}</span>`)}processTextColor(n){const t=/::color\[([^\]]+)\]\{([^}]+)\}/g;return n.replace(t,(e,i,r)=>`<span style="color: ${this.sanitizeColor(i)}">${r}</span>`)}processFontWeight(n){const t=/::weight\[([^\]]+)\]\{([^}]+)\}/g;return n.replace(t,(e,i,r)=>`<span style="font-weight: ${this.sanitizeWeight(i)}">${r}</span>`)}processAlignment(n){const t=/::align\[([^\]]+)\]\{([^}]+)\}/g;return n.replace(t,(e,i,r)=>`<span class="text-align-${this.sanitizeAlign(i)}">${r}</span>`)}processBold(n){const t=/::bold\{([^}]+)\}/g;return n.replace(t,'<span style="font-weight: bold">$1</span>')}processItalic(n){const t=/::italic\{([^}]+)\}/g;return n.replace(t,'<span style="font-style: italic">$1</span>')}processStrikethrough(n){const t=/::strike\{([^}]+)\}/g;return n.replace(t,'<span style="text-decoration: line-through">$1</span>')}sanitizeColor(n){const t=n.trim().toLowerCase();return["black","white","red","green","blue","yellow","orange","purple","pink","brown","gray","grey","cyan","magenta","lime","navy","teal","olive","maroon","aqua","fuchsia","silver","darkred","darkgreen","darkblue","lightgray","lightblue","lightgreen","lightyellow","transparent"].includes(t)||/^#([0-9a-f]{3}|[0-9a-f]{6})$/i.test(t)||/^rgba?\([^)]+\)$/i.test(t)?t:"inherit"}sanitizeWeight(n){const t=n.trim().toLowerCase();if(["normal","bold","bolder","lighter"].includes(t))return t;const e=parseInt(t,10);return!isNaN(e)&&e>=100&&e<=900&&e%100===0?e.toString():"normal"}sanitizeAlign(n){const t=n.trim().toLowerCase();return["left","center","right","justify"].includes(t)?t:"left"}};D.ɵfac=function(t){return new(t||D)},D.ɵpipe=W({name:"textFormat",type:D,pure:!0});let ct=D;const A=class A{transform(n){if(!n)return"";let t=n;return t=this.processQuoteCards(t),t=this.processVerseCards(t),t=this.processEpicCards(t),t=this.processHighlightCards(t),t=this.processGenericCards(t),t=this.processOlaiCards(t),t=this.processNewspaperCards(t),t}processQuoteCards(n){const t=/::quote\[([^\]]+)\]\{([^}]+)\}/g;let e=n.replace(t,(r,a,_)=>{const p=a.trim();return`<div class="card card--quote">
  ...
  <div class="card__newspaper-content">
    ...
    </div>`}escapeHtml(n){const t={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"};return n.replace(/[&<>"']/g,e=>t[e]||e)}};E.ɵfac=function(t){return new(t||E)},E.ɵpipe=W({name:"tabs",type:E,pure:!0});let dt=E;const mn={passwordHash:"ace3ec3d2bca9a0c0e280b3f654b9254965d7696",expiryTime:1440*60*1e3},X=mn,k=class k{constructor(){this.STORAGE_KEY="blog_auth_cache",this.EXPIRY_TIME=X.expiryTime}async sha1(n){const t=new TextEncoder().encode(n),e=await crypto.subtle.digest("SHA-1",t);return Array.from(new Uint8Array(e)).map(a=>a.toString(16).padStart(2,"0")).join("")}async validatePassword(n){return await this.sha1(n)===X.passwordHash}isAuthenticated(){const n=this.getCachedAuth();return n?Date.now()-n.timestamp>this.EXPIRY_TIME?(this.clearCache(),!1):n.hash===X.passwordHash:!1}saveAuth(){const n={hash:X.passwordHash,timestamp:Date.now()};localStorage.setItem(this.STORAGE_KEY,JSON.stringify(n))}getCachedAuth(){try{const n=localStorage.getItem(this.STORAGE_KEY);return n?JSON.parse(n):null}catch{return null}}clearCache(){localStorage.removeItem(this.STORAGE_KEY)}getRemainingTime(){const n=this.getCachedAuth();if(!n)return 0;const t=Date.now()-n.timestamp;return Math.max(0,this.EXPIRY_TIME-t)}};k.ɵfac=function(t){return new(t||k)},k.ɵprov=St({token:k,factory:k.ɵfac,providedIn:"root"});let tt=k;function hn(o,n){o&1&&(l(0,"span"),d(1,"👁️"),c())}function fn(o,n){o&1&&(l(0,"span"),d(1,"🙈"),c())}function bn(o,n){if(o&1&&(l(0,"p",16),d(1),c()),o&2){const t=g(2);s(),C(t.errorMessage())}}function Mn(o,n){if(o&1){const t=xt();l(0,"div",2),T("click",function(i){w(t);const r=g();return y(r.onOverlayClick(i))}),l(1,"div",3),T("click",function(i){return w(t),y(i.stopPropagation())}),l(2,"div",4)(3,"h2"),d(4,"🔒 Protected Content"),c(),l(5,"button",5),T("click",function(){w(t);const i=g();return y(i.cancel())}),d(6,"×"),c()(),l(7,"div",6)(8,"p",7),d(9,"This article is password protected. Please enter the password to continue."),c(),l(10,"div",8)(11,"input",9,0),$t("ngModelChange",function(i){w(t);const r=g();return Ht(r.password,i)||(r.password=i),y(i)}),T("keyup.enter",function(){w(t);const i=g();return y(i.submit())}),c(),l(13,"button",10),T("click",function(){w(t);const i=g();return y(i.togglePasswordVisibility())}),ot(14,hn,2,0,"span",11)(15,fn,2,0,"span",11),c()(),ot(16,bn,2,1,"p",12),c(),l(17,"div",13)(18,"button",14),T("click",function(){w(t);const i=g();return y(i.cancel())}),d(19,"Cancel"),c(),l(20,"button",15),T("click",function(){w(t);const i=g();return y(i.submit())}),d(21),c()()()()}if(o&2){const t=g();s(11),Pt("error",t.errorMessage()),b("type",t.showPassword()?"text":"password"),Bt("ngModel",t.password),s(2),Rt("aria-label",t.showPassword()?"Hide password":"Show password"),s(),b("ngIf",!t.showPassword()),s(),b("ngIf",t.showPassword()),s(),b("ngIf",t.errorMessage()),s(4),b("disabled",t.isValidating()),s(),G(" ",t.isValidating()?"Validating...":"Unlock"," ")}}const $=class ${constructor(){this.authService=vt(tt),this.isVisible=U(!1),this.password="",this.showPassword=U(!1),this.errorMessage=U(""),this.isValidating=U(!1)}show(){return this.isVisible.set(!0),this.password="",this.showPassword.set(!1),this.errorMessage.set(""),this.isValidating.set(!1),new Promise(n=>{this.resolvePromise=n})}hide(){this.isVisible.set(!1),this.password="",this.errorMessage.set("")}togglePasswordVisibility(){this.showPassword.set(!this.showPassword())}onOverlayClick(n){this.cancel()}async submit(){if(!this.password.trim()){this.errorMessage.set("Please enter a password");return}this.isValidating.set(!0),this.errorMessage.set("");try{await this.authService.validatePassword(this.password)?(this.authService.saveAuth(),this.hide(),this.resolvePromise?.(!0)):(this.errorMessage.set("Incorrect password. Please try again."),this.password="")}catch(n){this.errorMessage.set("An error occurred. Please try again."),console.error("Password validation error:",n)}finally{this.isValidating.set(!1)}}cancel(){this.hide(),this.resolvePromise?.(!1)}};$.ɵfac=function(t){return new(t||$)},$.ɵcmp=q({type:$,selectors:[["app-password-modal"]],decls:1,vars:1,consts:[["passwordInput",""],["class","modal-overlay",3,"click",4,"ngIf"],[1,"modal-overlay",3,"click"],[1,"modal-content",3,"click"],[1,"modal-header"],["aria-label","Close",1,"close-btn",3,"click"],[1,"modal-body"],[1,"modal-message"],[1,"password-input-group"],["placeholder","Enter password","autofocus","",1,"password-input",3,"ngModelChange","keyup.enter","type","ngModel"],["type","button",1,"toggle-password-btn",3,"click"],[4,"ngIf"],["class","error-message",4,"ngIf"],[1,"modal-footer"],[1,"btn","btn-cancel",3,"click"],[1,"btn","btn-submit",3,"click","disabled"],[1,"error-message"]],template:function(t,e){t&1&&ot(0,Mn,22,10,"div",1),t&2&&b("ngIf",e.isVisible())},dependencies:[Y,zt,Nt,Dt,At,Et],styles:[`.modal-overlay[_ngcontent-%COMP%] {
      position: fixed;
      top: 0;
      left: 0;
      right: 0;
    ...
    }`]});let nt=$;const K={enabled:!0,showOnAllPosts:!0,sectionTitle:"Support This Content",message:"If you found this content helpful, consider supporting the author.",showAfterDisclaimer:!0},Mt=[{name:"GPay",url:"",icon:"gpay",enabled:!0,type:"qr",upiId:"anand@oksbi",qrImage:"gpay-anand.png",description:"Pay via UPI using Google Pay or any UPI app"},{name:"PayPal",url:"https://paypal.me/actionanand",icon:"paypal",enabled:!0,type:"redirect",description:"Support via PayPal"},{name:"Buy Me A Coffee",url:"https://buymeacoffee.com/actionanand",icon:"buymeacoffee",enabled:!0,type:"redirect",description:"Buy me a coffee to support my work"},{name:"GitHub Sponsors",url:"https://github.com/sponsors/actionanand",icon:"github-sponsors",enabled:!0,type:"redirect",description:"Become a GitHub sponsor"},{name:"Patreon",url:"https://patreon.com/yourusername",icon:"patreon",enabled:!1,type:"redirect",description:"Support via Patreon"},{name:"Ko-fi",url:"https://ko-fi.com/actionanand",icon:"kofi",enabled:!0,type:"redirect",description:"Support via Ko-fi"}],Cn=(o,n)=>n.name;function xn(o,n){if(o&1&&(H(0,"p",4),d(1),L()),o&2){const t=g(2);s(),C(t.getDonationMessage())}}function vn(o,n){if(o&1&&(H(0,"a",7)(1,"span",9),d(2),L()()),o&2){const t=n.$implicit;_t("href",t.url,Q)("title",t.description),s(2),C(t.name)}}function Pn(o,n){if(o&1&&Gt(0,"img",11),o&2){let t;const e=g(3);_t("src",e.getAssetPath((t=e.gpay())==null?null:t.qrImage),Q)("alt","GPay QR for UPI "+(e.getUpiId(e.gpay())||""))}}function wn(o,n){if(o&1&&(H(0,"div",8)(1,"div",10),h(2,Pn,1,2,"img",11),H(3,"div",12)(4,"p",13),d(5),L()()()()),o&2){let t,e;const i=g(2);s(),_t("title",((t=i.gpay())==null?null:t.description)??"UPI via GPay"),s(),f((e=i.gpay())!=null&&e.qrImage?2:-1),s(3),C(i.getUpiId(i.gpay()))}}function yn(o,n){if(o&1&&(H(0,"div",0)(1,"div",1)(2,"div",2)(3,"h3",3),d(4),L(),h(5,xn,2,1,"p",4),L(),H(6,"div",5)(7,"div",6),F(8,vn,3,3,"a",7,Cn),L(),h(10,wn,6,3,"div",8),L()()()),o&2){const t=g();s(4),C(t.donationConfig.sectionTitle),s(),f(t.getDonationMessage()?5:-1),s(3),V(t.redirectPlatforms()),s(2),f(t.gpay()?10:-1)}}const B=class B{constructor(){this.platformId=vt(wt),this.isBrowser=yt(this.platformId),this.donationConfig=K,this.redirectPlatforms=mt(()=>Mt.filter(n=>n.enabled&&n.type==="redirect")),this.gpay=mt(()=>Mt.find(n=>n.enabled&&n.name==="GPay")??null)}shouldShowDonation(){return K.enabled?this.getPostAttribute("enableDonation")===!1?!1:K.showOnAllPosts?!0:this.getPostAttribute("enableDonation")===!0:this.getPostAttribute("enableDonation")===!0}getPostAttribute(n){if(!(!this.postAttributes||Object.keys(this.postAttributes).length===0))return this.postAttributes[n]}getDonationMessage(){return this.getPostAttribute("donationMessage")||K.message||""}getUpiId(n){return n?n.upiId??"":""}getAssetPath(n){if(!n)return"";if(!this.isBrowser)return`/${n}`;const t=document.querySelector("base")?.getAttribute("href")||"/";return`${t.endsWith("/")?t:`${t}/`}${n}`}};B.ɵfac=function(t){return new(t||B)},B.ɵcmp=q({type:B,selectors:[["app-donation"]],inputs:{postAttributes:"postAttributes"},decls:1,vars:1,consts:[[1,"donation-section"],[1,"donation-container"],[1,"donation-header"],[1,"donation-title"],[1,"donation-message"],[1,"donation-platforms"],[1,"donation-row","donation-row-links"],["target","_blank","rel","noopener noreferrer",1,"donation-platform","redirect-platform",3,"href","title"],[1,"donation-row","donation-row-gpay"],[1,"platform-name"],[1,"gpay-card",3,"title"],[1,"gpay-qr",3,"src","alt"],[1,"gpay-upi"],[1,"gpay-upi-id"]],template:function(t,e){t&1&&h(0,yn,11,3,"div",0),t&2&&f(e.shouldShowDonation()?0:-1)},dependencies:[Y],styles:[`
...
}`],changeDetection:0});let pt=B;const In=["contentRef"],Ot=o=>["/blog",o],Tt=(o,n)=>n.attributes.slug;function On(o,n){if(o&1&&(l(0,"p",5),d(1),I(2,"formatDate"),c()),o&2){const t=g(2);s(),C(O(2,1,t.attributes.date))}}function Tn(o,n){o&1&&(l(0,"span",7),d(1,"📝 Draft"),c())}function kn(o,n){o&1&&(l(0,"span",8),d(1,"📌 Pinned"),c())}function Ln(o,n){if(o&1&&(l(0,"span",23),d(1),c()),o&2){const t=n.$implicit;s(),C(t)}}function jn(o,n){if(o&1&&F(0,Ln,2,1,"span",23,Qt),o&2){const t=g(2);V(t.attributes.tags)}}function Sn(o,n){if(o&1&&(l(0,"div",24)(1,"strong"),d(2,"Author:"),c(),d(3),c()),o&2){const t=g(3);s(3),G(" ",t.attributes.author," ")}}function zn(o,n){if(o&1&&(l(0,"div",24)(1,"strong"),d(2,"Epic:"),c(),d(3),c()),o&2){const t=g(3);s(3),G(" ",t.attributes.epicName," ")}}function Nn(o,n){if(o&1&&(l(0,"div",24)(1,"strong"),d(2,"Verse Number:"),c(),d(3),c()),o&2){const t=g(3);s(3),G(" ",t.attributes.verseNumber," ")}}function Dn(o,n){if(o&1&&(l(0,"div",24)(1,"strong"),d(2,"Info:"),c(),d(3),c()),o&2){const t=g(3);s(3),G(" ",t.attributes.articleMetadata," ")}}function An(o,n){if(o&1&&(l(0,"div",10),h(1,Sn,4,1,"div",24),h(2,zn,4,1,"div",24),h(3,Nn,4,1,"div",24),h(4,Dn,4,1,"div",24),c()),o&2){const t=g(2);s(),f(t.attributes.author?1:-1),s(),f(t.attributes.epicName?2:-1),s(),f(t.attributes.verseNumber?3:-1),s(),f(t.attributes.articleMetadata?4:-1)}}function En(o,n){if(o&1&&P(0,"app-table-of-contents",14),o&2){const t=g(3);b("headings",t.headings)}}function $n(o,n){if(o&1&&(P(0,"analog-markdown",16),I(1,"processFootnotes"),I(2,"admonitionTransform"),I(3,"textFormat"),I(4,"cardFormat"),I(5,"tabs")),o&2){const t=g(2);b("content",O(5,9,O(4,7,O(3,5,O(2,3,O(1,1,typeof t.content=="string"?t.content:""))))))}}function Bn(o,n){if(o&1&&(l(0,"section",17)(1,"div",25),Jt(),l(2,"svg",26),P(3,"circle",27)(4,"line",28)(5,"circle",29),c(),Xt(),l(6,"h4"),d(7,"Disclaimer"),c()(),l(8,"p"),d(9),c()()),o&2){const t=g(3);s(9),C(t.disclaimerText)}}function Rn(o,n){if(o&1&&P(0,"img",32),o&2){const t=g().$implicit,e=g(4);b("src",t.attributes.coverImage||e.defaultCoverImage,Q)("alt",t.attributes.title)}}function Hn(o,n){if(o&1&&(l(0,"span",35),d(1),I(2,"formatDate"),c()),o&2){const t=g().$implicit;s(),C(O(2,1,t.attributes.date))}}function Gn(o,n){if(o&1&&(l(0,"li",31),h(1,Rn,1,2,"img",32),l(2,"div",33)(3,"a",34),d(4),c(),h(5,Hn,3,3,"span",35),c()()),o&2){const t=n.$implicit,e=g(4);s(),f(t.attributes.coverImage||e.defaultCoverImage?1:-1),s(2),b("routerLink",et(4,Ot,t.attributes.slug)),s(),C(t.attributes.title),s(),f(t.attributes.date?5:-1)}}function Zn(o,n){if(o&1&&(l(0,"div",20)(1,"h3"),d(2,"Related Posts"),c(),l(3,"ul",30),F(4,Gn,6,6,"li",31,Tt),c()()),o&2){const t=g(3);s(4),V(t.relatedPosts)}}function Un(o,n){if(o&1&&P(0,"img",32),o&2){const t=g(2).$implicit,e=g(4);b("src",t.attributes.coverImage||e.defaultCoverImage,Q)("alt",t.attributes.title)}}function qn(o,n){if(o&1&&(l(0,"span",35),d(1),I(2,"formatDate"),c()),o&2){const t=g(2).$implicit;s(),C(O(2,1,t.attributes.date))}}function Yn(o,n){if(o&1&&(l(0,"li",31),h(1,Un,1,2,"img",32),l(2,"div",33)(3,"a",34),d(4),c(),h(5,qn,3,3,"span",35),c()()),o&2){const t=g().$implicit,e=g(4);s(),f(t.attributes.coverImage||e.defaultCoverImage?1:-1),s(2),b("routerLink",et(4,Ot,t.attributes.slug)),s(),C(t.attributes.title),s(),f(t.attributes.date?5:-1)}}function Fn(o,n){if(o&1&&h(0,Yn,6,6,"li",31),o&2){const t=n.$implicit,e=g(4);f(t.attributes.slug!==e.currentSlug?0:-1)}}function Vn(o,n){if(o&1&&(l(0,"div",21)(1,"h3"),d(2,"Recent Posts"),c(),l(3,"ul",30),F(4,Fn,1,1,null,null,Tt),c()()),o&2){const t=g(3);s(4),V(t.recentPosts)}}function Wn(o,n){if(o&1&&(l(0,"article",1)(1,"header",3)(2,"h1",4),d(3),c(),h(4,On,3,3,"p",5),l(5,"div",6),h(6,Tn,2,0,"span",7),h(7,kn,2,0,"span",8),l(8,"span",9),d(9),c(),h(10,jn,2,0),c(),h(11,An,5,4,"div",10),l(12,"p",11),d(13),c()(),P(14,"img",12),l(15,"div",13),h(16,En,1,1,"app-table-of-contents",14),l(17,"div",15,0),h(19,$n,6,11,"analog-markdown",16),c()(),h(20,Bn,10,1,"section",17),P(21,"app-donation",18),l(22,"section",19),h(23,Zn,6,0,"div",20)(24,Vn,6,0,"div",21),c(),P(25,"app-post-navigation",22),c()),o&2){const t=g(),e=g();s(3),C(t.attributes.title),s(),f(t.attributes.date?4:-1),s(2),f(t.attributes.isDraft?6:-1),s(),f(t.attributes.isPinned?7:-1),s(2),C(t.attributes.category||"uncategorized"),s(),f(t.attributes.tags&&t.attributes.tags.length>0?10:-1),s(),f(t.attributes.author||t.attributes.epicName||t.attributes.verseNumber||t.attributes.articleMetadata?11:-1),s(2),C(t.attributes.description),s(),b("src",t.attributes.coverImage||e.defaultCoverImage,Q)("alt",t.attributes.title),s(),Pt("blog-post__container--no-toc",!e.showToc),s(),f(e.showToc&&e.headings.length>0?16:-1),s(3),f(t.content?19:-1),s(),f(e.showDisclaimer?20:-1),s(),b("postAttributes",t.attributes),s(2),f(e.relatedPosts.length>0?23:24),s(2),b("previousPost",e.previousPost)("nextPost",e.nextPost)}}function Qn(o,n){o&1&&(l(0,"div",2)(1,"div",36),d(2,"🔒"),c(),l(3,"h2"),d(4,"Protected Content"),c(),l(5,"p"),d(6,"This article is password protected. Please unlock to view."),c()())}function Jn(o,n){if(o&1&&h(0,Wn,26,19,"article",1)(1,Qn,7,0,"div",2),o&2){const t=g();f(t.isContentAccessible()?0:1)}}const R=class R{constructor(n,t,e,i){this.cdr=t,this.authService=e,this.router=i,this.post$=Zt("slug"),this.defaultCoverImage="tamil-literature-default.svg",this.isContentAccessible=U(!0),this.allPosts=[],this.headings=[],this.relatedPosts=[],this.recentPosts=[],this.previousPost=null,this.nextPost=null,this.currentSlug="",this.showToc=!0,this.showDisclaimer=!0,this.disclaimerText="The views expressed are personal and for informational purposes only.",this.hasExtractedHeadings=!1,this.isBrowser=yt(n);const a=Ut().filter(_=>!_.attributes.isDraft);this.allPosts=a.sort((_,p)=>_.attributes.isPinned&&!p.attributes.isPinned?-1:!_.attributes.isPinned&&p.attributes.isPinned?1:new Date(p.attributes.date||"").getTime()-new Date(_.attributes.date||"").getTime())}async ngOnInit(){this.post$.subscribe(async n=>{n&&(this.currentSlug=n.attributes.slug,n.attributes.enableLock?await this.handleAuthentication():this.isContentAccessible.set(!0),this.showToc=n.attributes.toc!==!1,this.showDisclaimer=n.attributes.disclaimerEnabled!==!1,this.disclaimerText=n.attributes.disclaimerText||this.disclaimerText,this.updateNavigation(),this.updateRelatedPosts(n.attributes.relatedPosts),this.recentPosts=this.allPosts.slice(0,Kt.articleRecentPostsCount+1),this.headings=[],this.hasExtractedHeadings=!1,this.isBrowser&&setTimeout(()=>{this.setupFootnoteNavigation()},100))})}ngAfterViewInit(){this.updateContentHeadings(),this.isBrowser&&(this.initObserver(),this.setupFootnoteNavigation())}ngAfterViewChecked(){!this.hasExtractedHeadings&&this.contentRef?.nativeElement&&this.isBrowser&&this.contentRef.nativeElement.querySelectorAll("h1, h2, h3, h4").length>0&&this.headings.length===0&&setTimeout(()=>{this.updateContentHeadings(),this.cdr.detectChanges()},0)}ngOnDestroy(){this.mutationObserver&&(this.mutationObserver.disconnect(),this.mutationObserver=void 0)}updateContentHeadings(){if(!this.isBrowser||!this.contentRef?.nativeElement)return;const n=this.contentRef.nativeElement,t=n.querySelectorAll("h1, h2, h3, h4");if(t.length===0)return;t.forEach(r=>{if(!r.id){const a=r.textContent||"";r.id=this.slugify(a)}});const e=n.innerHTML,i=nn(e);i.length>0&&!this.hasExtractedHeadings&&(this.headings=i,this.hasExtractedHeadings=!0)}initObserver(){this.isBrowser&&this.contentRef?.nativeElement&&(this.mutationObserver||(this.mutationObserver=new MutationObserver(()=>{this.updateContentHeadings(),this.setupFootnoteNavigation()}),this.mutationObserver.observe(this.contentRef.nativeElement,{childList:!0,subtree:!0,characterData:!0})))}setupFootnoteNavigation(){if(!this.isBrowser)return;const n=document.querySelector("article.blog-post");if(!n)return;const t=n.cloneNode(!0);n.parentNode&&n.parentNode.replaceChild(t,n);const e=i=>{const a=i.target.getAttribute("data-fn");if(a){i.preventDefault(),i.stopPropagation();const _=a,p=document.getElementById(_);if(p){p.scrollIntoView({behavior:"smooth",block:"start"});const M=document.querySelector("base")?.getAttribute("href")||"/",m=`${M.endsWith("/")?M:`${M}/`}blog/${this.currentSlug}#${_}`;console.log("Updating URL to:",m),window.history.replaceState(null,"",m)}}};t.addEventListener("click",i=>{const r=i.target;(r.classList.contains("footnote-ref")||r.classList.contains("footnote-backref"))&&e(i)})}slugify(n){return n.toLowerCase().replace(/[^a-z0-9\s-]/g,"").trim().replace(/\s+/g,"-").replace(/-+/g,"-")}updateNavigation(){const n=this.allPosts.findIndex(t=>t.attributes.slug===this.currentSlug);n>0?this.previousPost=this.allPosts[n-1]:this.previousPost=null,n<this.allPosts.length-1?this.nextPost=this.allPosts[n+1]:this.nextPost=null}updateRelatedPosts(n){if(this.relatedPosts=[],!n||n.length===0)return;n.slice(0,5).forEach(e=>{const i=this.allPosts.find(r=>r.attributes.slug===e);i&&this.relatedPosts.push(i)})}async handleAuthentication(){if(this.authService.isAuthenticated()){this.isContentAccessible.set(!0);return}this.isContentAccessible.set(!1),setTimeout(async()=>{this.passwordModal&&(await this.passwordModal.show()?(this.isContentAccessible.set(!0),this.cdr.detectChanges()):this.router.navigate(["/blog"]))},100)}};R.ɵfac=function(t){return new(t||R)(J(wt),J(qt),J(tt),J(Yt))},R.ɵcmp=q({type:R,selectors:[["app-blog-post"]],viewQuery:function(t,e){if(t&1&&Wt(In,5)(nt,5),t&2){let i;ht(i=ft())&&(e.contentRef=i.first),ht(i=ft())&&(e.passwordModal=i.first)}},decls:3,vars:3,consts:[["contentRef",""],[1,"blog-post"],[1,"locked-content"],[1,"blog-post__header"],[1,"blog-post__title"],[1,"blog-post__date"],[1,"blog-post__meta"],[1,"post-meta-tag","draft-tag"],[1,"post-meta-tag","pinned-tag"],[1,"post-meta-tag","category-tag"],[1,"blog-post__article-meta"],[1,"blog-post__description"],[1,"blog-post__image",3,"src","alt"],[1,"blog-post__container"],[1,"blog-post__toc",3,"headings"],[1,"blog-post__content"],[3,"content"],[1,"blog-post__disclaimer"],[3,"postAttributes"],[1,"blog-post__related"],[1,"related-posts"],[1,"recent-posts"],[3,"previousPost","nextPost"],[1,"post-meta-tag","tag-tag"],[1,"article-meta-item"],[1,"disclaimer-header"],["viewBox","0 0 24 24","fill","currentColor",1,"disclaimer-icon"],["cx","12","cy","12","r","10","fill","none","stroke","currentColor","stroke-width","2"],["x1","12","y1","8","x2","12","y2","12","stroke","currentColor","stroke-width","2","stroke-linecap","round"],["cx","12","cy","16","r","0.5","fill","currentColor"],[1,"posts-list"],[1,"post-item"],[1,"post-thumbnail",3,"src","alt"],[1,"post-info"],[1,"post-link",3,"routerLink"],[1,"post-date"],[1,"locked-icon"]],template:function(t,e){if(t&1&&(P(0,"app-password-modal"),h(1,Jn,2,1),I(2,"async")),t&2){let i;s(),f((i=O(2,1,e.post$))?1:-1,i)}},dependencies:[Y,gt,Ft,it,at,nt,pt,Vt,rt,st,ct,lt,dt,tn],styles:[`.blog-post[_ngcontent-%COMP%] {
      max-width: 900px;
      margin: 0 auto;
    }
